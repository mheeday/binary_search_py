...
def binary_sort2(entry_list, item):
    entry_list = sorted(entry_list)
    if entry_list[0] == item:
        return 0
    elif entry_list[len(entry_list)-1] == item:
...
print(timeit("binary_sort(arr, to_find)", 'from __main__ import normal_find, binary_sort, arr, to_find', number=10000))
print(timeit("binary_sort2(arr, to_find)", 'from __main__ import normal_find, binary_sort2, arr, to_find', number=10000))
print(timeit("normal_find(arr, to_find)", 'from __main__ import normal_find, binary_sort, arr, to_find',  number=10000))